    ...
    ***************************************************************************** */
    ...
    var Gesto = /*#__PURE__*/ (function (_super) {
        ...
        Gesto.prototype.onPinchStart = function (e) {
            ...
            var result = this.emit("pinchStart", __assign$1(__assign$1({ data: this.data, datas: this.data, angle: store.getAngle(), touches: this.getCurrentStore().getPositions() }, store.getPosition()), { inputEvent: e, isTrusted: this._isTrusted }));
            if (result === false) {
                this.pinchFlag = false;
            }
        };
