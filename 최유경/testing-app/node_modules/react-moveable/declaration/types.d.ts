...
export declare type RotationPosition = "top" | "bottom" | "left" | "right" | "top-right" | "top-left" | "bottom-right" | "bottom-left" | "left-top" | "left-bottom" | "right-top" | "right-bottom" | "none";
/**
 * @typedef
 * @memberof Moveable.Rotatable
 * @extends Moveable.RenderDirections
 ...
 * @memberof Moveable
 */
export declare type MoveableTargetGroupsType = Array<HTMLElement | SVGElement | MoveableTargetGroupsType>;
/**
 * @typedef
...
export interface MoveableInterface {
     ...
     */
    request<RequestParam extends {} = AbleRequestParam>(ableName: string, params?: RequestParam, isInstant?: boolean): Requester<RequestParam>;
    destroy(): void;
...
export declare type ExcludeParams<T extends IObject<any>> = ExcludeKeys<T, keyof OnEvent>;
export declare type ExcludeEndParams<T extends IObject<any>> = ExcludeKeys<ExcludeParams<T>, "lastEvent" | "isDrag" | "isDouble">;
