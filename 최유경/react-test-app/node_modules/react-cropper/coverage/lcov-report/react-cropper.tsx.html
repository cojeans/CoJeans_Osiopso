...
<head>
    <title>Code coverage report for react-cropper.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> react-cropper.tsx</h1>
        <div class='clearfix'>
...
&nbsp;
     ...
     */
    useEffect(() =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (combinedRef.current?.cropper &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof zoomTo === 'number')</span> {
<span class="cstat-no" title="statement not covered" >            combinedRef.current.cropper.zoomTo(zoomTo);</span>
        }
    }, [props.zoomTo]);
&nbsp;
    /**
    ...
    useEffect(() =&gt; {
        if (combinedRef.current !== null) {
            const cropper = new Cropper(combinedRef.current, {
                dragMode,
                ...rest,
                ready: <span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
<span class="cstat-no" title="statement not covered" >                    if (e.currentTarget !== null) {</span>
<span class="cstat-no" title="statement not covered" >                        applyDefaultOptions(e.currentTarget.cropper, defaultOptions);</span>
                    }
<span class="cstat-no" title="statement not covered" >                    ready &amp;&amp; ready(e);</span>
                },
            });
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Jun 28 2021 09:22:05 GMT+0200 (Central European Summer Time)
            </div>
        </div>
